					...
					foreach( $bookingpress_location_staff_special_days as $loc_staff_sd_data ){
						...
						if( !empty( $bookingpress_location_staff_special_day_breaks ) ){
							foreach( $bookingpress_location_staff_special_day_breaks as $staff_loc_sp_break_timings ){
								...
								$break_hour_timings[] = array(
									'break_start_time' => date('H:i', strtotime( $staff_loc_sp_break_timings->bookingpress_location_staff_special_day_break_start_time ) ),
									'break_end_time' => date('H:i', strtotime( $staff_loc_sp_break_timings->bookingpress_location_staff_special_day_break_end_time ) )
								);
							}
						}
					...
					if( empty( $staff_special_day_service_id ) ){
						...
						if( !empty( $staff_special_day_breaks ) ){
							foreach( $staff_special_day_breaks as $staff_sp_break_timings ){
								...
								$break_hour_timings[] = array(
									'break_start_time' => date('H:i', strtotime( $staff_sp_break_timings->bookingpress_special_day_break_start_time ) ),
									'break_end_time' => date('H:i', strtotime( $staff_sp_break_timings->bookingpress_special_day_break_end_time ) )
								);
							}
						}
						...
						if( in_array( $selected_service_id, $avl_services ) ){
							...
							if( !empty( $staff_special_day_breaks ) ){
								foreach( $staff_special_day_breaks as $staff_sp_break_timings ){
									...
									$break_hour_timings[] = array(
										'break_start_time' => date('H:i', strtotime( $staff_sp_break_timings['start_time'] ) ),
										'break_end_time' => date('H:i', strtotime( $staff_sp_break_timings['end_time'] ) )
									);
								}
							}
						}
