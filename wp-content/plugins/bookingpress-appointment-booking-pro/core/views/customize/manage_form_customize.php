...
<el-main class="bpa-main-listing-card-container bpa-default-card bpa--is-page-scrollable-tablet" id="all-page-main-container">
    ...
    <el-container class="bpa-customize-main-container" id="bpa-main-container">          
        <div class="bpa-customize-body-wrapper">                        
            <div class="bpa-cmc--tab-menu">                                
                <div class="bpa-cms-tm__body">
                    <el-radio-group v-model="bpa_activeTabName" @change ="bookingpress_change_tab(bpa_activeTabName)">
                        ...
                        <?php 
                            do_action('bookingpress_customize_tab_menu_after');
                        ?>
                    </el-radio-group>
                </div>
            </div>                           
            <div class="bpa-customize-step-top-panel">
                <div class="bpa-tp__body">
                    <div class="bpa-tp__body-item">                           
                        ...
                        <el-select v-model="selected_font_values.title_font_family" class="bpa-form-control" popper-class="bpa-el-select--is-with-navbar" filterable @change="bookingpress_change_border_color">
                    ...
                    <?php 
                        do_action('bookingpress_customize_color_setting_after');
                    ?>                    
                    <div class="bpa-tp__body-item">
                        <div class="bpa-bi__title">
            ...
            <el-tabs class="bpa-tabs bpa-tabs--customize-module" v-model="activeTabName">                    
                                ...
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-sm--swtich">
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            ...
                                            <el-tooltip class="item" effect="dark" content="" placement="top" v-if="hide_service_step_disabled === true">
                                            <template #content>
                                                <span><?php esc_html_e('Category & Service step can be hide only when it is set to the first step', 'bookingpress-appointment-booking'); ?></span>
                                            </template>
                                            <el-switch v-model="booking_form_settings.hide_category_service_selection" class="bpa-swtich-control" :disabled="hide_service_step_disabled"></el-switch>
                                            </el-tooltip>
                                            <template v-else>
                                            <el-switch v-model="booking_form_settings.hide_category_service_selection" class="bpa-swtich-control" :disabled="hide_service_step_disabled" @change="bookingpress_after_change_position"></el-switch>
                                            </template>
                                        </div> 
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                        ...
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Hide service duration', 'bookingpress-appointment-booking'); ?></label>
                                            <el-switch v-model="booking_form_settings.hide_service_duration" class="bpa-swtich-control"></el-switch>
                                        </div>   										
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Hide service price', 'bookingpress-appointment-booking'); ?></label>
                                            <el-switch v-model="booking_form_settings.hide_service_price" class="bpa-swtich-control"></el-switch>
                                        </div>
                                        <div class="bpa-sm--item --bpa-is-flexbox" v-if="is_staffmember_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Hide', 'bookingpress-appointment-booking'); ?> <?php echo esc_html($bookingpress_singular_staffmember_name); ?> <?php esc_html_e('selection', 'bookingpress-appointment-booking'); ?></label>
                                            <el-switch v-model="booking_form_settings.hide_staffmember_selection" class="bpa-swtich-control" @change="bookingpress_after_change_position"></el-switch>
                                        </div>
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                        ...
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Hide time slot grouping', 'bookingpress-appointment-booking'); ?></label>
                                            <el-switch v-model="booking_form_settings.hide_time_slot_grouping" class="bpa-swtich-control"></el-switch>
                                        </div>                                                                               
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Hide Capacity Information', 'bookingpress-appointment-booking') ?></label>
                                            <el-switch v-model="booking_form_settings.hide_capacity_text" class="bpa-swtich-control"></el-switch>
                                        </div>   
                                        <div class="bpa-sm--item --bpa-is-flexbox" v-if="typeof is_gcaptcha_activated !== 'undefined' && is_gcaptcha_activated == 1">
                                            <label class="bpa-form-label"><?php esc_html_e( 'Enable google recaptcha', 'bookingpress-appointment-booking' ); ?></label>
                                            <el-switch v-model="booking_form_settings.enable_google_captcha" class="bpa-swtich-control"></el-switch>
                                        </div>	
                                        <?php do_action('bookingpress_customization_booking_form_extra_hide_option'); ?>
                                    </div>
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        ...
                                        <div class="bpa-sm--item" v-if="true == is_display_form_sequence">
                                            <el-row type="flex" class="bpa-customize-lp-field"> 
                                                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">													
                                                    <label class="bpa-form-label"><?php esc_html_e('Booking form sequence', 'bookingpress-appointment-booking'); ?></label>                                                    
                                                    <div class="bpa-customize-form-sequence__items">
                                                        <draggable :list="booking_form_sequence" class="list-group" ghost-class="ghost" @start="dragging = true" @end="updateSequencePos($event)">
                                                            <div class="bpa-cfs__item-card" v-for="(form_sequence, key) in booking_form_settings.bookingpress_form_sequance" :data-form_sequence="form_sequence" v-if="( typeof booking_form_settings.bpa_sequence_item_visibility == 'undefined' || ( 'undefined' != typeof booking_form_settings.bpa_sequence_item_visibility && 'undefined' != typeof booking_form_settings.bpa_sequence_item_visibility[form_sequence] && true == booking_form_settings.bpa_sequence_item_visibility[form_sequence] ))">
                                                                <div class="bpa-cfs__body">
                                                                    <div class="bpa-cfs__item-counter">{{ booking_form_settings.bpa_sequance_pos[ form_sequence ] }}</div>
                                                                    <div class="bpa-cfs__step-val" v-if="form_sequence == 'service_selection'"><?php esc_html_e('Service Selection', 'bookingpress-appointment-booking'); ?></div>
                                                                    <?php do_action( 'bookingpress_form_sequence_list_item') ?>
                                                                </div>
                                                                <div class="bpa-cfs__drag-icon">
                                        ...
                                        <div class="bpa-sm--item" v-if="is_staffmember_activated == '1'">
                                            <el-row type="flex" class="bpa-customize-lp-field"> 
                                                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">													
                                                    <label class="bpa-form-label"><?php echo esc_html( $bookingpress_singular_staffmember_name ); ?> <?php esc_html_e('Information', 'bookingpress-appointment-booking'); ?></label>                                                                    
                                                    <el-select v-model="booking_form_settings.bookingpress_staffmember_information" class="bpa-form-control"  popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                        <el-option label="<?php esc_html_e('Show both phone number and emaill address','bookingpress-appointment-booking'); ?>" value="1"></el-option>														
                                                        <el-option label="<?php esc_html_e('Show only email address','bookingpress-appointment-booking'); ?>" value="2"></el-option>														
                                                        <el-option label="<?php esc_html_e('Show only phone number','bookingpress-appointment-booking'); ?>" value="3"></el-option>
                                                        <el-option label="<?php esc_html_e('Don\'t show both phone number and emaill address','bookingpress-appointment-booking'); ?>" value="4"></el-option>
                                                    </el-select>    													
                                                </el-col>
                                            </el-row>                                            
                                        </div>	
                                        <?php do_action('bookingpress_staff_customize_extra_form_option'); ?>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Time slot styling for the booking form', 'bookingpress-appointment-booking'); ?></label>  
                                            <el-select v-model="booking_form_settings.bookigpress_time_format_for_booking_form" class="bpa-form-control"  popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) ?>" value="1" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) ?>" value="2" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true" ><?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) ?>" value="5" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) ?>" value="6" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ) ) ?>" value="3" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ) ) ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ) ) ?>" value="4" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ) ) ?></el-option>
                                                <el-option v-if="booking_form_settings.bookigpress_check_inherit_time_format == true" label="<?php esc_html_e('Inherit From Wordpress', 'bookingpress-appointment-booking'); ?>" value="bookingpress-wp-inherit-time-format"><?php esc_html_e('Inherit From Wordpress', 'bookingpress-appointment-booking'); ?></el-option>
                                            </el-select>
                                        </div>
                                        <?php do_action('bookingpress_add_customize_booking_form_panel'); ?>
                                        <div class="bpa-sm--item">
                                            <h5><?php esc_html_e('Appointment booking redirection', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <el-radio v-model="booking_form_settings.redirection_mode" label="in-built"><?php esc_html_e('In-built', 'bookingpress-appointment-booking'); ?></el-radio>
                                            <el-radio v-model="booking_form_settings.redirection_mode" label="external_redirection"><?php esc_html_e('External Redirection', 'bookingpress-appointment-booking'); ?></el-radio>
                                        </div>	
                                        <div v-if="booking_form_settings.redirection_mode == 'external_redirection'">   
                                            <div class="bpa-sm--item">             
                                            <label class="bpa-form-label"><?php esc_html_e('Upon success', 'bookingpress-appointment-booking'); ?></label>                                            
                                                <el-select v-model="booking_form_settings.after_booking_redirection" popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel" class="bpa-form-control"  filterable
                                                    popper-class="bpa-el-select--is-with-navbar">
                                        ...
                                        <div v-if="booking_form_settings.redirection_mode == 'in-built'" class="bpa-customize-redirection-mode__in-built">   
                                            <div class="bpa-sm--item" >
                                                <el-row type="flex" class="bpa-customize-lp-field">
                                                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="18">													
                                                        <label class="bpa-form-label"><?php esc_html_e('Thank you message', 'bookingpress-appointment-booking'); ?></label>     
                                                    </el-col>	
                                                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="1">	
                                                        <el-button class="bpa-btn bpa-btn__medium bpa-btn__filled-light" @click="open_add_redirection_modal('thankyou')">
                                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M12 3.72667V0.666667C12 0.3 11.7 0 11.3333 0H8.27333C7.68 0 7.38 0.72 7.8 1.14L8.86 2.2L2.19333 8.86667L1.13333 7.80667C0.72 7.38667 0 7.68 0 8.27333V11.3333C0 11.7 0.3 12 0.666667 12H3.72667C4.32 12 4.62 11.28 4.2 10.86L3.14 9.8L9.80667 3.13333L10.8667 4.19333C11.28 4.61333 12 4.32 12 3.72667Z" fill="#535D71"/>
                                                            </svg>
                                                        </el-button>
                                                    </el-col>
                                                </el-row>	                                                                                  
                                            ...
                                            <div class="bpa-sm--item" >												
                                                <el-input type="textarea" :rows="4" resize="none" v-model="booking_form_settings.bookingpress_thankyou_msg" class="bpa-form-control"></el-input>              
                                            </div>	
                                            <div class="bpa-sm--item">
                                                <el-row type="flex" class="bpa-customize-lp-field">
                                                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="18">													
                                                        <label class="bpa-form-label"><?php esc_html_e('Failed Payment', 'bookingpress-appointment-booking'); ?></label>   
                                                    </el-col>	
                                                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="1">	
                                                        <el-button class="bpa-btn bpa-btn__medium bpa-btn__filled-light" @click="open_add_redirection_modal('failed_payment')">
                                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M12 3.72667V0.666667C12 0.3 11.7 0 11.3333 0H8.27333C7.68 0 7.38 0.72 7.8 1.14L8.86 2.2L2.19333 8.86667L1.13333 7.80667C0.72 7.38667 0 7.68 0 8.27333V11.3333C0 11.7 0.3 12 0.666667 12H3.72667C4.32 12 4.62 11.28 4.2 10.86L3.14 9.8L9.80667 3.13333L10.8667 4.19333C11.28 4.61333 12 4.32 12 3.72667Z" fill="#535D71"/>
                                                            </svg>
                                                        </el-button>
                                            ...
                                            <div class="bpa-sm--item" >				
                                                <el-input type="textarea" :rows="4" resize="none" v-model="booking_form_settings.bookingpress_failed_payment_msg" class="bpa-form-control"></el-input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <el-col :xs="16" :sm="16" :md="16" :lg="16" :xl="16">
                                <div class="bpa-customize-booking-form-preview-container">
                                    <el-tabs class="bpa-tabs bpa-cbf--tabs" v-model="formActiveTab">
                                        <el-tab-pane :name="current_element.name" v-for="current_element in bookingpress_form_sequance_arr" v-if="current_element.is_visible == '1'">
                                            <template #label>
                                                <a :class="formActiveTab == current_element.name ? 'bpa_center_container_tab_title' : ''" :style="[ formActiveTab == current_element.name ? { 'color': selected_colorpicker_values.primary_color,'font-family': selected_font_values.title_font_family} : {'color': selected_colorpicker_values.sub_title_color,'font-size': selected_font_values.content_font_size+'px','font-family': selected_font_values.title_font_family} ]">
                                                    <span class="material-icons-round" :style="[ formActiveTab == current_element.name ? { 'background': selected_colorpicker_values.primary_color, 'border-color': selected_colorpicker_values.primary_color } : {'color': selected_colorpicker_values.content_color,'border-color':selected_colorpicker_values.border_color} ]">{{current_element.icon}}</span>
                                                    {{tab_container_data[current_element.title]}}
                                                </a>                                                                               
                                            </template>
                                            <div class="bpa-cbf--preview-step" :style="{ 'background': selected_colorpicker_values.background_color,'border-color': selected_colorpicker_values.border_color }" v-if="current_element.name == 1">
                                                                    ...
                                                                    <div class="bpa-front-si-card" :style="[bookingpress_shortcode_form.selected_service == 'chronic_disease_management_1' ? { 'border-color': selected_colorpicker_values.primary_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                        ...
                                                                        <div class="bpa-front-si__card-body">
                                                                            ...
                                                                            <div class="bpa-front-si-cb__specs">
                                                                                <div class="bpa-front-si-cb__specs-item" v-if="booking_form_settings.hide_service_duration == false">
                                                                                    ...
                                                                                    <strong :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">4 {{booking_form_settings.book_appointment_hours_text}}</strong>
                                                                                </div>
                                                                                <div class="bpa-front-si-cb__specs-item" v-if="booking_form_settings.hide_service_price == false">
                                                                    ...
                                                                    <div class="bpa-front-si-card" :style="[bookingpress_shortcode_form.selected_service == 'chronic_disease_management_4' ? { 'border-color': selected_colorpicker_values.primary_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                        ...
                                                                        <div class="bpa-front-si__card-body">
                                                                            ...
                                                                            <div class="bpa-front-si-cb__specs">
                                                                                <div class="bpa-front-si-cb__specs-item" v-if="booking_form_settings.hide_service_duration == false">
                                                                                    <p :style="{ 'color': selected_colorpicker_values.content_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family}">{{ booking_form_settings.service_duration_label }}</p>
                                                                                    <strong :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">1 {{booking_form_settings.book_appointment_day_text}}</strong>
                                                                                </div>
                                                                                <div class="bpa-front-si-cb__specs-item" v-if="booking_form_settings.hide_service_price == false">
                                                                                    <p :style="{ 'color': selected_colorpicker_values.content_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }">{{ booking_form_settings.service_price_label }}</p>
                                                                                    <strong class="bpa-front-text-primary-color --is-service-price" :style="{ 'background-color': selected_colorpicker_values.primary_color, 'color': selected_colorpicker_values.price_button_text_color, 'font-family': selected_font_values.title_font_family}"><?php echo esc_html($bookingpress_service_price2); ?></strong>
                                            ...
                                            <div class="bpa-cbf--preview-step __is-calendar-step" :style="{ 'background': selected_colorpicker_values.background_color,'border-color': selected_colorpicker_values.border_color }" v-if="current_element.name == 2">
                                                <div class="bpa-cbf--preview-step__body-content">                                                    
                                                    <div class="bpa-cbf--preview--module-container __cal-and-time">
                                                        <el-row>
                                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                                <div class="bpa-front-module-heading" v-text="tab_container_data.datetime_title" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.title_font_size+'px', 'font-family': selected_font_values.title_font_family }"></div>
                                                                ...
                                                                <div class="bpa-front--dt__time-slots" :style="{'border-color':selected_colorpicker_values.border_color}">
                                                                    ...
                                                                    <div class="bpa-front--dt__ts-body">
                                                                        ...
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            <div class="bpa-front--dt-ts__sub-heading" v-if="booking_form_settings.hide_time_slot_grouping != true">
                                                                                <div class="bpa-front--dt-ts__sub-heading" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">{{ timeslot_container_data.morning_text }}
                                                                                </div>
                                                                            </div>                                                                            
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item __bpa-is-disabled" :style="{'background-color':selected_colorpicker_values.border_alpha_color,'border-color': selected_colorpicker_values.border_color}">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                    ...
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                    ...
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                        {{ '09:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '09:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('09:30')" :style="[bookingpress_shortcode_form.selected_time == '09:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '09:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '09:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '09:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '10:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('10:00')" :style="[bookingpress_shortcode_form.selected_time == '10:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                    <?php echo esc_html(date_i18n($bookingpress_default_time_format,strtotime('10:00'))).' - '.esc_html(date_i18n($bookingpress_default_time_format,strtotime('10:30')));?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '10:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('10:30')" :style="[bookingpress_shortcode_form.selected_time == '10:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '11:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '11:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '11:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('11:00')" :style="[bookingpress_shortcode_form.selected_time == '11:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '11:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '11:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '11:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '11:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '11:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                        ...
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            <div class="bpa-front--dt-ts__sub-heading" v-if="booking_form_settings.hide_time_slot_grouping != true">
                                                                                <div class="bpa-front--dt-ts__sub-heading" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">
                                                                                    {{ timeslot_container_data.afternoon_text }}
                                                                                </div>
                                                                            </div>
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '12:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('12:00')" :style="[bookingpress_shortcode_form.selected_time == '12:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '12:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '12:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '12:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '12:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '12:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                    <?php echo esc_html(date_i18n($bookingpress_default_time_format,strtotime('12:00'))).' - '.esc_html(date_i18n($bookingpress_default_time_format,strtotime('12:30')));?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '12:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('12:30')" :style="[bookingpress_shortcode_form.selected_time == '12:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '12:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '13:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '12:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '13:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '12:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '13:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('13:00')" :style="[bookingpress_shortcode_form.selected_time == '13:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '13:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '13:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '13:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '13:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '13:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '13:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('13:30')" :style="[bookingpress_shortcode_form.selected_time == '13:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '13:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '14:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '13:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '14:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }"> 
                                                                                        {{ '13:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                        ...
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            <div class="bpa-front--dt-ts__sub-heading" v-if="booking_form_settings.hide_time_slot_grouping != true">
                                                                                <div class="bpa-front--dt-ts__sub-heading" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">
                                                                                    {{ timeslot_container_data.evening_text }}
                                                                                </div>
                                                                            </div>                                                                            
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '17:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('17:00')" :style="[bookingpress_shortcode_form.selected_time == '17:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '17:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '17:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '17:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '17:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '17:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '17:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('17:30')" :style="[bookingpress_shortcode_form.selected_time == '17:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '17:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '18:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '17:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '18:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '17:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                    <?php echo esc_html(date_i18n($bookingpress_default_time_format,strtotime('17:30'))).' - '.esc_html(date_i18n($bookingpress_default_time_format,strtotime('18:00')));?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '18:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('18:00')" :style="[bookingpress_shortcode_form.selected_time == '18:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '18:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '18:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '18:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '18:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '18:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '18:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('18:30')" :style="[bookingpress_shortcode_form.selected_time == '18:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '18:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '19:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '18:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '19:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '18:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                        ...
                                                                        <div class="bpa-front--dt__ts-body--row">
                                                                            <div class="bpa-front--dt-ts__sub-heading" v-if="booking_form_settings.hide_time_slot_grouping != true">
                                                                            <div class="bpa-front--dt-ts__sub-heading" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}">
                                                                                {{ timeslot_container_data.night_text }}
                                                                                </div>
                                                                            </div>                                                                            
                                                                            <div class="bpa-front--dt__ts-body--items">
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '20:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('20:00')" :style="[bookingpress_shortcode_form.selected_time == '20:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '20:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '20:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '20:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '20:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '20:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                    <?php echo esc_html(date_i18n($bookingpress_default_time_format,strtotime('20:00'))).' - '.esc_html(date_i18n($bookingpress_default_time_format,strtotime('20:30')));?>
                                                                                    </span>
                                                                                </div>
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '20:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('20:30')" :style="[bookingpress_shortcode_form.selected_time == '20:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '20:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '21:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '20:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '21:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '20:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '21:00') ? '__bpa-is-selected' : ''" @click="bpa_select_time('21:00')" :style="[bookingpress_shortcode_form.selected_time == '21:00' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '21:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '21:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '21:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '21:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '21:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                                                                ...
                                                                                <div class="bpa-front--dt__ts-body--item" :class="(bookingpress_shortcode_form.selected_time == '21:30') ? '__bpa-is-selected' : ''" @click="bpa_select_time('21:30')" :style="[bookingpress_shortcode_form.selected_time == '21:30' ? { 'border-color': selected_colorpicker_values.primary_color, 'background': selected_colorpicker_values.primary_background_color } : {'border-color': selected_colorpicker_values.border_color}]">
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }"> 
                                                                                        {{ '21:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '22:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '21:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '22:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family }">
                                                                                        {{ '21:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                                    </span>
                                                                                    <span v-if="booking_form_settings.bookigpress_time_format_for_booking_form == 'bookingpress-wp-inherit-time-format'" :style="{ 'color': selected_colorpicker_values.sub_title_color, 'font-size': selected_font_values.content_font_size+'px', 'font-family': selected_font_values.title_font_family}">
                                            ...
                                            <div class="bpa-cbf--preview-step __is-basic-details-step" :style="{ 'background': selected_colorpicker_values.background_color,'border-color': selected_colorpicker_values.border_color}" v-if="current_element.name == 3">
                                                <div class="bpa-cbf--preview-step__body-content">                                                    
                                                ...
                                                <div class="bpa-front-tabs--foot" :style="{ 'background': selected_colorpicker_values.background_color,'border-color':selected_colorpicker_values.border_color }">
                                                    ...
                                                    <el-button class="bpa-btn bpa-btn--primary" :style="{ 'background': selected_colorpicker_values.primary_color, 'border-color': selected_colorpicker_values.primary_color, color: selected_colorpicker_values.price_button_text_color,'font-size': selected_font_values.sub_title_font_size+'px','font-family': selected_font_values.title_font_family,'font-size': selected_font_values.sub_title_font_size+'px'}" v-if="current_element.next_tab != ''">
                                                        <span>{{ booking_form_settings.next_button_text}} <strong>{{ tab_container_data[current_element.next_tab] }}</strong></span>
                                                        <span class="material-icons-round">east</span>
                                                    </el-button>
                                                </div>
                                            </div>

                                            <div class="bpa-cbf--preview-step __is-summary-step" :style="{ 'background': selected_colorpicker_values.background_color,'border-color':selected_colorpicker_values.border_color+' !important' }" v-if="current_element.name == 4">
                                                <div class="bpa-cbf--preview-step__body-content">                                                    
                                                    <div class="bpa-cbf--preview--module-container">
                                                        <el-row>
                                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                                <div class="bpa-front-module-container bpa-front-module--booking-summary">
                                                                    ...
                                                                    <div class="bpa-front-module--bs-summary-content">
                                                                        ...
                                                                        <div class="bpa-front-module--bs-summary-content-item" :style="{'border-color':selected_colorpicker_values.border_color}">
                                                                            ...
                                                                            <div class="bpa-front-bs-sm__item-val" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }" v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '1' || booking_form_settings.bookigpress_time_format_for_booking_form == '2'">
                                                                                <?php echo date($bookingpress_default_date_format, current_time( 'timestamp' ) ); // phpcs:ignore ?>,{{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} to {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                            </div>
                                                                            <div class="bpa-front-bs-sm__item-val" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }" v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '5' || booking_form_settings.bookigpress_time_format_for_booking_form == '6'">
                                                                                <?php echo date_i18n($bookingpress_default_date_format, current_time( 'timestamp' ) ); // phpcs:ignore ?>,{{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }} - {{ '10:30' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                            </div>
                                                                            <div class="bpa-front-bs-sm__item-val" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }" v-if="booking_form_settings.bookigpress_time_format_for_booking_form == '3' || booking_form_settings.bookigpress_time_format_for_booking_form == '4'"><?php echo date($bookingpress_default_date_format, current_time( 'timestamp' ) ); // phpcs:ignore ?>,{{ '10:00' | bookingpress_customize_format_time(booking_form_settings.bookigpress_time_format_for_booking_form) }}
                                                                            </div>
                                                                            <div class="bpa-front-bs-sm__item-val" :style="{ 'color': selected_colorpicker_values.label_title_color, 'font-size': selected_font_values.sub_title_font_size+'px', 'font-family': selected_font_values.title_font_family }" v-if="booking_form_settings.bookigpress_time_format_for_booking_form =='bookingpress-wp-inherit-time-format'"><?php 
                                                                            echo esc_html(date_i18n($bookingpress_default_date_format, current_time('timestamp'))).', '. 
                                                                            esc_html(date_i18n($bookingpress_default_time_format,strtotime('10:00'))).' - '.esc_html(date_i18n($bookingpress_default_time_format,strtotime('10:30')));?>
                                                                            </div>
                                                                        </div>
                                                                        <div class="bpa-front-module--bs-summary-content-item">
                                                                            <span :style="{'color': selected_colorpicker_values.sub_title_color, 'font-family': selected_font_values.title_font_family,'font-size': selected_font_values.content_font_size+'px' }">{{front_label_edit_data.customer_text}}</span>
                                                                    ...
                                                                    <div class="bpa-front-module--bs-amount-details" :style="{'border-color':selected_colorpicker_values.border_color}">
                                                                        <div class="bpa-fm--bs-amount-item">   
                                                                            ...
                                                                            <div class="bpa-front-module--bs-ad--price" :style="{ 'color': selected_colorpicker_values.primary_color, 'font-family': selected_font_values.title_font_family }" class="bpa-front-module--bs-ad--price"><?php echo esc_html($bookingpress_price); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <?php
                                            do_action('bookingpress_add_customize_booking_form_tab');
                                            ?>
                                        </el-tab-pane>
                                    </el-tabs>
                                </div>
                                ...
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">                                        
                                        ...
                                        <div class="bpa-sm--item">
                                            ...
                                            <el-input v-model="booking_form_settings.book_appointment_btn_text" class="bpa-form-control"></el-inpu
                                            t>        
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Day label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="booking_form_settings.book_appointment_day_text" class="bpa-form-control"></el-input>        
                                        </div>
                                        <h5 v-if="is_staffmember_activated == '1'"><?php esc_html_e('Staff step labels', 'bookingpress-appointment-booking'); ?></h5>                                        
                                        <div class="bpa-sm--item" v-if="is_staffmember_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Staff step', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="tab_container_data.staffmember_title " class="bpa-form-control"></el-input>
                                        </div>                                        
                                        <?php
                                            do_action('bookingpress_add_label_settings_dynamically');
                                        ?>
                                        <h5><?php esc_html_e('Service step labels', 'bookingpress-appointment-booking'); ?></h5>                                        
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Step service', 'bookingpress-appointment-booking'); ?></label>
                                        ...
                                        <div class="bpa-sm--item" v-if="is_servie_extra_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Service extra title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.service_extra_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_bring_anyone_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('No. of Person title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.bring_anyone_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <!--
                                        <div class="bpa-sm--item" v-if="is_bring_anyone_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Number of guests title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.number_of_guest_title" class="bpa-form-control"></el-input>
                                        </div> -->
                                        <div class="bpa-sm--item" v-if="is_bring_anyone_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Person title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.number_of_person_title" class="bpa-form-control"></el-input>
                                        </div>                                        
                                        <div class="bpa-sm--item" v-if="is_staffmember_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Staff member title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.staffmember_heading_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_staffmember_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Any staff title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.any_staff_title" class="bpa-form-control"></el-input>
                                        </div>                                        
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item" >
                                            <label class="bpa-form-label"><?php esc_html_e('Continue button', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.continue_button_title" class="bpa-form-control"></el-input>
                                        </div>                                        
                                        <div class="bpa-sm--item" >
                                            <label class="bpa-form-label"><?php esc_html_e('Cancel button', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="service_container_data.cancel_button_title" class="bpa-form-control"></el-input>
                                        </div>                                                                       
                                        <h5><?php esc_html_e('Date & Time labels', 'bookingpress-appointment-booking'); ?></h5>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Step Date & Time', 'bookingpress-appointment-booking'); ?></label>
                                        ...
                                        <div class="bpa-sm--item">
                                            ...
                                            <!-- <el-input v-model="timeslot_container_data.date_time_step_note" class="bpa-form-control"></el-input> -->
                                            <el-input type="textarea" :rows="2" v-model="timeslot_container_data.date_time_step_note"> </el-input>
                                        </div>                                   
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Remaining slots title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="timeslot_container_data.slot_left_text" class="bpa-form-control"></el-input>
                                        </div>                                   
                                        <?php
                                        do_action('bookingpress_add_bookingform_label_data') 
                                        ?>
                                        <h5><?php esc_html_e('Basic details step labels', 'bookingpress-appointment-booking'); ?></h5>                                                    
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Step basic details', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="tab_container_data.basic_details_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <?php
                                        do_action('bookingpress_add_booking_form_basic_details_data');
                                        ?>                                       
                                        <h5><?php esc_html_e('Summary step labels', 'bookingpress-appointment-booking'); ?></h5>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Summary step', 'bookingpress-appointment-booking'); ?></label>
                                        ...
                                        <div class="bpa-sm--item">
                                            ...
                                            <!-- <el-input v-model="summary_container_data.summary_step_note" class="bpa-form-control"></el-input> -->
                                            <el-input type="textarea" :rows="2" v-model="summary_container_data.summary_step_note"> </el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Service extras label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.service_extras_label"> </el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Subtotal title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.subtotal_text" class="bpa-form-control"></el-input>
                                        </div>                                        
                                        <div class="bpa-sm--item">
                                        ...
                                        <!-- Coupon label -->
                                        <div class="bpa-sm--item" v-if="is_coupon_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Coupon heading title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.coupon_code_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_coupon_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Enter coupon placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.coupon_code_field_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_coupon_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Coupon apply button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.coupon_apply_button_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_coupon_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('coupon applied title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.couon_applied_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <!-- Deposit label -->
                                        <div class="bpa-sm--item" v-if="is_deposit_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Deposit heading title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.deposit_heading_title" class="bpa-form-control"></el-input>
                                        </div>                         
                                        <div class="bpa-sm--item" v-if="is_deposit_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Deposit payment amount title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.deposit_paying_amount_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_deposit_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Deposit remaining amount title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.deposit_remaining_amount_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_deposit_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Deposit title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.deposit_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item" v-if="is_deposit_activated == '1'">
                                            <label class="bpa-form-label"><?php esc_html_e('Full payment title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="summary_container_data.full_payment_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <?php
                                            do_action('bookingpress_add_booking_form_summary_label_data');
                                        ?>      
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Card details title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.card_details_text" class="bpa-form-control"></el-input>
                                        </div>  
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Card name placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.card_name_text" class="bpa-form-control"></el-input>
                                        </div>  
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Card number placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.card_number_text" class="bpa-form-control"></el-input>
                                        </div>  
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Expire month placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.expire_month_text" class="bpa-form-control"></el-input>
                                        </div>  
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Expire year placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.expire_year_text" class="bpa-form-control"></el-input>
                                        </div>                
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Cvv placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.cvv_text" class="bpa-form-control"></el-input>
                                        </div>

                                        <h5><?php esc_html_e('Payment Link Labels', 'bookingpress-appointment-booking'); ?></h5>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Deposit amount title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.complete_payment_deposit_amt_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Make Payment button title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.make_payment_button_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <?php  do_action('bookingpress_add_customize_extra_section') ?>                                        
                                    </div>   
                                </div>   
                            </el-col>
                        </el-row>
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-sm--swtich">
                                        ...
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e( 'Allow customers to reschedule their appointments', 'bookingpress-appointment-booking' ); ?></label>
                                            <el-switch v-model="my_booking_field_settings.allow_customer_reschedule_apt" class="bpa-swtich-control"></el-switch>
                                        </div>
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e( 'Allow customers to edit their profile', 'bookingpress-appointment-booking' ); ?></label>
                                            <el-switch v-model="my_booking_field_settings.allow_customer_edit_profile" class="bpa-swtich-control"></el-switch>
                                        </div>
				                    </div>						
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" >
                                        <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                            <div class="bpa-sm--item">
                                                ...
                                                <el-select v-model="my_booking_field_settings.appointment_cancellation_confirmation" class="bpa-form-control" filterable popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                    <el-option v-for="item in bookingpress_all_global_pages" :key="item.post_title" :label="item.post_title"  :value="''+item.ID"></el-option>
                                                </el-select>
                                            </div>
                                        </div>
                                        <div class="bpa-sm--item">
                                            ...
                                            <el-select v-model="my_booking_field_settings.after_cancelled_appointment_redirection" class="bpa-form-control" filterable popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                <el-option v-for="item in bookingpress_all_global_pages" :key="item.post_title" :label="item.post_title"  :value="''+item.ID"></el-option>
                                            </el-select>
                                        </div>
                                        <div class="bpa-sm--item">
                                    ...
                                    <div class="bpa-cmb-step-preview" :style="{ 'background': selected_colorpicker_values.background_color }">                                
                                        ...
                                        <div class="bpa-front-cp-ma-table__is-admin">
                                            <div class="bpa-front-ma-table__head" :style="{'border-color':selected_colorpicker_values.border_color}">
                                                ...
                                                <div class="bpa-mat-head__item" :style="{'color': selected_colorpicker_values.label_title_color,'font-family': selected_font_values.title_font_family }" v-if="is_staffmember_activated == '1'">
                                                    <?php esc_html_e('Staff', 'bookingpress-appointment-booking'); ?>
                                                </div>
                                                <div class="bpa-mat-head__item" :style="{'color': selected_colorpicker_values.label_title_color,'font-family': selected_font_values.title_font_family }">
                                            ...
                                            <div class="bpa-front-ma-table__body">
                                                <div class="bpa-front-mat__row" v-for="row_data in dummy_data">
                                                    ...
                                                    <div class="bpa-mat-body__item" v-if="is_staffmember_activated == '1'">
                                                        <span :style="{'color': selected_colorpicker_values.sub_title_color,'font-family': selected_font_values.title_font_family }">{{row_data.appointment_staff}}</span>
                                                    </div>
                                                    <div class="bpa-mat-body__item">
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">       
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Edit account title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.edit_account_title " class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Change password title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.change_password_title " class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Logout title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.logout_title " class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Delete account heading title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.delete_account_heading_title" class="bpa-form-control"></el-input>
                                        </div>       
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Delete account description', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.delete_account_desc" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Delete account button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.delete_account_button_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('staff title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.staff_main_heading" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('No. Of Person title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.booking_guest_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Extras details title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.booking_extra_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Deposit title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.booking_deposit_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Tax title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.booking_tax_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Coupon title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.booking_coupon_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item" v-if="typeof is_invoice_activated !== 'undefined' && is_invoice_activated == 1">
                                            <label class="bpa-form-label"><?php esc_html_e('Download invoice button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.invoice_button_label" class="bpa-form-control"></el-input>
                                        </div>       
                                        <?php do_action('bpa_add_label_outside_my_booking_form'); ?>                
                                        <div class="bpa-sm--item">											
                                            <h5><?php esc_html_e('Login Related Messages', 'bookingpress-appointment-booking'); ?> </h5>
                                        </div>										
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Login form title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_title" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Username / Email field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_username_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Username / Email field Placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_username_field_placeholder" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Password label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_password_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Password field Placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_password_field_placeholder" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('User name required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_username_required_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Password required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_password_required_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Remember Me field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_remember_me_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Login button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_button_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Forgot Password link label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_link_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Error message label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_error_msg_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">											
                                            <h5><?php esc_html_e('Forgot Password Messages', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Forgot Password form title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_form_title" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Email address field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_form_email_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Email address placeholder label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_email_placeholder_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Email required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_form_email_required_field_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Forgot password button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_form_button_label" class="bpa-form-control"></el-input>
                                        </div>             										
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Error message label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_form_error_msg_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Success message label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_form_success_msg_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Sign In Link Label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.forgot_password_signin_link_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">											
                                            <h5><?php esc_html_e('Edit Account Messages', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('My profile title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.my_profile_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Update Profile Button Label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.update_profile_btn" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Update Profile Success Message', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.update_profile_success_msg" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">											
                                            <h5><?php esc_html_e('Change Password Messages', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Current password label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.current_password_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('New password label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.new_password_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Confirm password label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.confirm_password_label" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Current password placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.current_password_placeholder" class="bpa-form-control"></el-input>
                                        </div>             										
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('New password placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.new_password_placeholder" class="bpa-form-control"></el-input>
                                        </div>             
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Confirm password placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.confirm_password_placeholder" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Update password button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.update_password_btn_text" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Update password success message', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.update_password_success_message" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Update password error message', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.update_password_error_message" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Current password required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.old_password_error_msg" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('New password required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.new_password_error_msg" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Confirm password required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.confirm_password_error_msg" class="bpa-form-control"></el-input>
                                        </div>

                                        <div class="bpa-sm--item">
                                            <h5><?php esc_html_e('Reschedule Appointment Messages', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Reschedule title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Popup title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_popup_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Popup description', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_popup_description" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Date label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_date_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Time label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_time_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Time Placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_time_placeholder" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Cancel button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_cancel_btn_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Update button label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_update_btn_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Reschedule appointment success message', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.reschedule_appointment_success_msg" class="bpa-form-control"></el-input>
                                        </div>
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Paid amount label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.paid_amount_text" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Refund amount label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.refund_amount_text" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Refund payment method label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.refund_payment_gateway_text" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Apply button text (my booking)', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.refund_apply_text" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Cancel button text (my booking)', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.refund_cancel_text" class="bpa-form-control"></el-input>
                                        </div>
                                        <?php do_action("bookingpress_add_my_booking_form_labels"); ?>
                                    </div>    
                                </div>
                            </el-col>
                        </el-row>
                ...
                <?php 
                    do_action('bookingpress_customize_tab_after');
                ?>
            </el-tabs>
        </div>    
    </el-container>    
    ...
    <el-dialog custom-class="bpa-dialog bpa-dialog--redirection_msg_model" title="" :visible.sync="add_redirection_msg_modal" :visible.sync="centerDialogVisible" close-on-press-escape="close_modal_on_esc" :modal="add_redirection_msg_modal" @open="bookingpress_enable_modal" @close="bookingpress_disable_modal">
    <div class="bpa-dialog-heading">
        <el-row type="flex">
            <el-col :xs="12" :sm="12" :md="16" :lg="16" :xl="16" >
                <h1 class="bpa-page-heading"  v-if="bookingpress_redirection_action_type == 'thankyou'"><?php esc_html_e('Thank You Message', 'bookingpress-appointment-booking'); ?></h1>
                <h1 class="bpa-page-heading"  v-else><?php esc_html_e('Failed Payment Message', 'bookingpress-appointment-booking'); ?></h1>
            </el-col>
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="8">
                <div class="bpa-hw-right-btn-group">
                    <el-button class="bpa-btn bpa-btn__medium bpa-btn--primary" @click="bookingpress_save_redirection_msg()" >                    
                        <span class="bpa-btn__label"><?php esc_html_e('OK', 'bookingpress-appointment-booking'); ?></span>                        
                    </el-button> 
                    <el-button class="bpa-btn bpa-btn__medium" @click="close_add_redirection_modal()">
                        <span>close</span>
                    </el-button>                    
                </div>
            </el-col>
    ...
    <div class="bpa-dialog-body">
        <div class="bpa-dialog--rm_body">						
            <el-form class="bpa-en-body-card__content--form" id="redirection_message_form" ref="redirection_message_form" @submit.native.prevent>
                <el-form-item>
                    <?php $bookingpress_message_content_editor = array(
                        'textarea_name' => 'bookigpress_redirection_msg',
                        'media_buttons' => false,
                        'textarea_rows' => 10,
                        'default_editor' => 'html',
                        'editor_css' => '',
                    ...
                    wp_editor('', 'bookigpress_redirection_msg', $bookingpress_message_content_editor);
                    ?>
                </el-form-item>
            </el-form>
        </div>
    ...
    <?php  do_action('bookingpress_add_manage_customized_view_bottom'); ?>
